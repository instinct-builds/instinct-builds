...
set -euo pipefail
cd "$(dirname "$0")/.."
rm -rf out/MUEW.app out/MUEW-0.16.0.dmg out/MUEW-distribution
...
hdiutil create -volname MUEW -srcfolder out/MUEW-distribution -ov -format UDZO out/MUEW-0.16.0.dmg
