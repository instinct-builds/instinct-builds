...
@interface MUEWAUEditorContainer_0_8 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_8
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_8* weakSelf = self;
...
@interface MUEWViewFactory_0_8 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_8
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_8* v = [[MUEWAUEditorContainer_0_8 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
