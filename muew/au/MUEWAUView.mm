...
@interface MUEWAUEditorContainer_0_16 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_16
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_16* weakSelf = self;
...
@interface MUEWViewFactory_0_16 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_16
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_16* v = [[MUEWAUEditorContainer_0_16 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
