...
@interface MUEWAUEditorContainer_0_62 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_62
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_62* weakSelf = self;
...
@interface MUEWViewFactory_0_62 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_62
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_62* v = [[MUEWAUEditorContainer_0_62 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
