...
@interface MUEWAUEditorContainer_0_18 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_18
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_18* weakSelf = self;
...
@interface MUEWViewFactory_0_18 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_18
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_18* v = [[MUEWAUEditorContainer_0_18 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
