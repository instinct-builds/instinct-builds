...
@interface MUEWAUEditorContainer_0_65 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_65
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_65* weakSelf = self;
...
@interface MUEWViewFactory_0_65 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_65
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_65* v = [[MUEWAUEditorContainer_0_65 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
