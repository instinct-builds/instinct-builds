...
@interface MUEWAUEditorContainer_0_21 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_21
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_21* weakSelf = self;
...
@interface MUEWViewFactory_0_21 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_21
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_21* v = [[MUEWAUEditorContainer_0_21 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
