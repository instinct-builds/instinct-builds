...
@interface MUEWAUEditorContainer_0_28 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_28
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_28* weakSelf = self;
...
@interface MUEWViewFactory_0_28 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_28
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_28* v = [[MUEWAUEditorContainer_0_28 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
