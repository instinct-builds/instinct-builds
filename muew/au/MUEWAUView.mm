...
@interface MUEWAUEditorContainer_0_47 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_47
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_47* weakSelf = self;
...
@interface MUEWViewFactory_0_47 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_47
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_47* v = [[MUEWAUEditorContainer_0_47 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
