...
@interface MUEWAUEditorContainer_0_36 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_36
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_36* weakSelf = self;
...
@interface MUEWViewFactory_0_36 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_36
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_36* v = [[MUEWAUEditorContainer_0_36 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
