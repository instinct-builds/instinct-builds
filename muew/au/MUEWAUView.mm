...
@interface MUEWAUEditorContainer_0_29 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_29
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_29* weakSelf = self;
...
@interface MUEWViewFactory_0_29 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_29
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_29* v = [[MUEWAUEditorContainer_0_29 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
