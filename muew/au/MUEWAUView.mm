...
@interface MUEWAUEditorContainer_0_9 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_9
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_9* weakSelf = self;
...
@interface MUEWViewFactory_0_9 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_9
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_9* v = [[MUEWAUEditorContainer_0_9 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
