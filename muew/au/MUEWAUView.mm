...
@interface MUEWAUEditorContainer_0_20 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_20
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_20* weakSelf = self;
...
@interface MUEWViewFactory_0_20 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_20
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_20* v = [[MUEWAUEditorContainer_0_20 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
