...
@interface MUEWAUEditorContainer_0_41 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_41
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_41* weakSelf = self;
...
@interface MUEWViewFactory_0_41 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_41
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_41* v = [[MUEWAUEditorContainer_0_41 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
