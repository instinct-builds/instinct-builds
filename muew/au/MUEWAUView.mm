...
@interface MUEWAUEditorContainer_0_17 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_17
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_17* weakSelf = self;
...
@interface MUEWViewFactory_0_17 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_17
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_17* v = [[MUEWAUEditorContainer_0_17 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
