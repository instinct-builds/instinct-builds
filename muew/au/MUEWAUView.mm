...
@interface MUEWAUEditorContainer_0_52 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_52
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_52* weakSelf = self;
...
@interface MUEWViewFactory_0_52 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_52
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_52* v = [[MUEWAUEditorContainer_0_52 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
