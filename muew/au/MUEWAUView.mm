...
@interface MUEWAUEditorContainer_0_22 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_22
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_22* weakSelf = self;
...
@interface MUEWViewFactory_0_22 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_22
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_22* v = [[MUEWAUEditorContainer_0_22 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
