...
@interface MUEWAUEditorContainer_0_35 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_35
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_35* weakSelf = self;
...
@interface MUEWViewFactory_0_35 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_35
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_35* v = [[MUEWAUEditorContainer_0_35 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
