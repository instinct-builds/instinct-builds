...
@interface MUEWAUEditorContainer_0_54 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_54
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_54* weakSelf = self;
...
@interface MUEWViewFactory_0_54 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_54
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_54* v = [[MUEWAUEditorContainer_0_54 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
