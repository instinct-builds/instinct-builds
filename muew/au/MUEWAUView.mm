...
@interface MUEWAUEditorContainer_0_39 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_39
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_39* weakSelf = self;
...
@interface MUEWViewFactory_0_39 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_39
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_39* v = [[MUEWAUEditorContainer_0_39 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
