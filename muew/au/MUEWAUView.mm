...
@interface MUEWAUEditorContainer_0_33 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_33
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_33* weakSelf = self;
...
@interface MUEWViewFactory_0_33 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_33
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_33* v = [[MUEWAUEditorContainer_0_33 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
