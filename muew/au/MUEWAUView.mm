...
@interface MUEWAUEditorContainer_0_13 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_13
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_13* weakSelf = self;
...
@interface MUEWViewFactory_0_13 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_13
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_13* v = [[MUEWAUEditorContainer_0_13 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
