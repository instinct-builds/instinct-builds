...
@interface MUEWAUEditorContainer_0_10 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_10
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_10* weakSelf = self;
...
@interface MUEWViewFactory_0_10 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_10
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_10* v = [[MUEWAUEditorContainer_0_10 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
