...
@interface MUEWAUEditorContainer_0_40 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_40
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_40* weakSelf = self;
...
@interface MUEWViewFactory_0_40 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_40
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_40* v = [[MUEWAUEditorContainer_0_40 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
