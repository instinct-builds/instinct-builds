...
@interface MUEWAUEditorContainer_0_53 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_53
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_53* weakSelf = self;
...
@interface MUEWViewFactory_0_53 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_53
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_53* v = [[MUEWAUEditorContainer_0_53 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
