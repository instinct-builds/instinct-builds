...
@interface MUEWAUEditorContainer_0_14 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_14
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_14* weakSelf = self;
...
@interface MUEWViewFactory_0_14 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_14
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_14* v = [[MUEWAUEditorContainer_0_14 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
