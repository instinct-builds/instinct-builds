...
@interface MUEWAUEditorContainer_0_27 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_27
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_27* weakSelf = self;
...
@interface MUEWViewFactory_0_27 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_27
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_27* v = [[MUEWAUEditorContainer_0_27 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
