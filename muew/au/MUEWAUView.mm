...
@interface MUEWAUEditorContainer_0_50 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_50
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_50* weakSelf = self;
...
@interface MUEWViewFactory_0_50 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_50
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_50* v = [[MUEWAUEditorContainer_0_50 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
