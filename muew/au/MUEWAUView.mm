...
@interface MUEWAUEditorContainer_0_46 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_46
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_46* weakSelf = self;
...
@interface MUEWViewFactory_0_46 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_46
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_46* v = [[MUEWAUEditorContainer_0_46 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
