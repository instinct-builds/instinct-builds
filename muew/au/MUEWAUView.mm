...
@interface MUEWAUEditorContainer_0_51 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_51
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_51* weakSelf = self;
...
@interface MUEWViewFactory_0_51 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_51
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_51* v = [[MUEWAUEditorContainer_0_51 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
