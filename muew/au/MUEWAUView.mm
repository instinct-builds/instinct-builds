...
@interface MUEWAUEditorContainer_0_56 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_56
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_56* weakSelf = self;
...
@interface MUEWViewFactory_0_56 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_56
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_56* v = [[MUEWAUEditorContainer_0_56 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
