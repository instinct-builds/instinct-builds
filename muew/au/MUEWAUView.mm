...
@interface MUEWAUEditorContainer_0_38 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_38
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_38* weakSelf = self;
...
@interface MUEWViewFactory_0_38 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_38
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_38* v = [[MUEWAUEditorContainer_0_38 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
