...
@interface MUEWAUEditorContainer_0_37 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_37
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_37* weakSelf = self;
...
@interface MUEWViewFactory_0_37 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_37
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_37* v = [[MUEWAUEditorContainer_0_37 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
