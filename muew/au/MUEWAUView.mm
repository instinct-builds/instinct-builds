...
@interface MUEWAUEditorContainer_0_44 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_44
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_44* weakSelf = self;
...
@interface MUEWViewFactory_0_44 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_44
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_44* v = [[MUEWAUEditorContainer_0_44 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
