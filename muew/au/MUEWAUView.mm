...
@interface MUEWAUEditorContainer_0_64 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_64
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_64* weakSelf = self;
...
@interface MUEWViewFactory_0_64 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_64
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_64* v = [[MUEWAUEditorContainer_0_64 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
