...
@interface MUEWAUEditorContainer_0_59 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_59
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_59* weakSelf = self;
...
@interface MUEWViewFactory_0_59 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_59
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_59* v = [[MUEWAUEditorContainer_0_59 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
