...
@interface MUEWAUEditorContainer_0_49 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_49
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_49* weakSelf = self;
...
@interface MUEWViewFactory_0_49 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_49
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_49* v = [[MUEWAUEditorContainer_0_49 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
