...
@interface MUEWAUEditorContainer_0_15 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_15
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_15* weakSelf = self;
...
@interface MUEWViewFactory_0_15 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_15
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_15* v = [[MUEWAUEditorContainer_0_15 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
