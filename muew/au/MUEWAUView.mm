...
@interface MUEWAUEditorContainer_0_42 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_42
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_42* weakSelf = self;
...
@interface MUEWViewFactory_0_42 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_42
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_42* v = [[MUEWAUEditorContainer_0_42 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
