...
@interface MUEWAUEditorContainer_0_34 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_34
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_34* weakSelf = self;
...
@interface MUEWViewFactory_0_34 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_34
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_34* v = [[MUEWAUEditorContainer_0_34 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
