...
@interface MUEWAUEditorContainer_0_48 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_48
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_48* weakSelf = self;
...
@interface MUEWViewFactory_0_48 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_48
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_48* v = [[MUEWAUEditorContainer_0_48 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
