...
@interface MUEWAUEditorContainer_0_66 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_66
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_66* weakSelf = self;
...
@interface MUEWViewFactory_0_66 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_66
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_66* v = [[MUEWAUEditorContainer_0_66 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
