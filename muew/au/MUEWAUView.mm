...
@interface MUEWAUEditorContainer_0_45 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_45
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_45* weakSelf = self;
...
@interface MUEWViewFactory_0_45 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_45
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_45* v = [[MUEWAUEditorContainer_0_45 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
