...
@interface MUEWAUEditorContainer_0_43 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_43
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_43* weakSelf = self;
...
@interface MUEWViewFactory_0_43 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_43
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_43* v = [[MUEWAUEditorContainer_0_43 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
