...
@interface MUEWAUEditorContainer_0_30 : MUEWEditorView {
@public
    AUEditorHost* auHost;
    NSTimer* follow;
}
...
@implementation MUEWAUEditorContainer_0_30
...
- (void)viewDidMoveToWindow {
    ...
    if (self.window && auHost) {
        __weak MUEWAUEditorContainer_0_30* weakSelf = self;
...
@interface MUEWViewFactory_0_30 : NSObject <AUCocoaUIBase>
@end

@implementation MUEWViewFactory_0_30
...
- (NSView*)uiViewForAudioUnit:(AudioUnit)inAudioUnit withSize:(NSSize)inPreferredSize {
    ...
    MUEWAUEditorContainer_0_30* v = [[MUEWAUEditorContainer_0_30 alloc] initWithFrame:NSMakeRect(0, 0, 1000, 680)];
