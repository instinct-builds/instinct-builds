...
int main() {
    static_assert(params::Count == 30 && params::PhaserMix == 28 && params::FlangerMix == 29 && params::Filter2Reso == 27 && params::SubLevel == 23 && params::WtPosA == 21 && params::CompAmount == 20, "parameter IDs are append-only");
