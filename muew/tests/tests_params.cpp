...
int main() {
    static_assert(params::Count == 40 && params::SpecMorphA == 38 && params::SpecMorphB == 39 && params::ReverbSize == 36 && params::CompUpward == 37 && params::HyperMix == 34 && params::FilterFxCutoff == 35 && params::ArpGate == 32 && params::ArpSwing == 33 && params::GlideTime == 30 && params::UnisonBlend == 31 && params::PhaserMix == 28 && params::FlangerMix == 29 && params::Filter2Reso == 27 && params::SubLevel == 23 && params::WtPosA == 21 && params::CompAmount == 20, "parameter IDs are append-only");
